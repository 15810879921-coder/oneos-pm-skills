...
| Skill | 说明 | 安装命令 |
|-------|------|----------|
| `oneos-autoprd` | 整模块 AutoPRD + 标注目录；**需求定稿**写功能变更记录；云效建需求时提供需求说明/更新内容 | 见下方 |
| `AutoVUL` | OneOS PC 版本更新日志：新功能/Bug修复分类、同模块合并、责任部门自然表述 | 见下方 |
...
建需求时先跑本 Skill，再写云效「需求说明」「更新内容」。口令见 `yunxiao-requirement-lifecycle`（v5.2+）。
...
1. 填写 `skills/AutoVUL/input-template.md`
2. 对 AI 说：
