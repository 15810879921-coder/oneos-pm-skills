...
- 写「需求说明 / 更新内容」仍按 AutoPRD 主流程与定稿流程；发云效时 **MD 全文直写**，见 [yunxiao-description.md](yunxiao-description.md)。
- 推进到待开发且需要描述时：先落盘并 **整份粘贴** `requirements-prd.md`，再改状态，再按本文件建任务（负责人何斐）。
