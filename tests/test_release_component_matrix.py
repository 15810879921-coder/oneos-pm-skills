...
class ReleaseComponentMatrixTests(unittest.TestCase):
    ...
    def test_new_contract_requires_valid_ledger_and_bidirectional_anchor_fields(self):
        ...
        self.assertEqual(errors, [])
        self.assertEqual(result["suiteVersion"], "10.1.2")
        del value["codeAnchors"][0]["branchInstanceId"]
        errors, _ = MODULE.validate(value)
        self.assertIn("codeAnchors[0].branchInstanceId is required for suiteVersion 10.1.2", errors)
