#!/usr/bin/env python3
"""Check the 10.2.15 installation UI without changing the user's clipboard."""
import argparse
...
def main():
    ...
    parser.add_argument("--url", default="http://127.0.0.1:18761/#lifecycle-10-2-12")
    ...
    with sync_playwright() as p:
        ...
        page.locator("#lifecycle-10-2-12").scroll_into_view_if_needed()
        if args.screenshot:
