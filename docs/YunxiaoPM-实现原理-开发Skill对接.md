...
| 主题 | 路径 |
|---|---|
| Skill 入口 | `YunxiaoPM/SKILL.md` |
| 已定口径 | `YunxiaoPM/references/settled-rules.md` |
| 交付树模型 | `YunxiaoPM/references/model.md` |
| 交棒契约 | `YunxiaoPM/references/handoff-contract.md` |
| 【开发】描述（仅优化） | `YunxiaoPM/references/dev-task-description.md` |
| 标准路径 0–5 | `YunxiaoPM/references/stage-flow.md` |
| 交棒门禁 / 回退 | `YunxiaoPM/references/handoff-and-rollback.md` |
| 描述双段 | `YunxiaoPM/references/description-split.md` |
| 编号区块 | `YunxiaoPM/references/workitem-ids.md` |
