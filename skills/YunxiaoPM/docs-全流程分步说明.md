...
|---|---|
| **谁** | AI（开发完成后触发） |
| **做什么** | 【新增】才按**精确需求编号**查正式测试计划；无计划走轻量验证，不建测试任务；有计划只执行当前交付端标记的用例范围，失败回流开发 |
| **需求状态** | 首个正式范围开始执行后为 **测试中**；其他端可继续开发 |
...
|---|---|
| **谁** | 开发人员（自测也完成） |
| **做什么** | 仅有正式计划的当前交付范围建 **【测试】**；无计划新增和优化写轻量验证，不因缺计划卡住 |
| **需求状态** | 无正式计划时，全部轻量验证范围闭环后直接 → **测试完成**；首个正式范围由测试开始后 → **测试中** |
| **口令例** | `完成开发：ONEOS-d` |
| **为什么** | 开发交棒给测试；测试侧开始接单 |
