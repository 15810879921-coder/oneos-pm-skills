...
## 0b. 虚拟形象 · 作战室定妆（本尊 2026-08-13 恢复）

**作战室「双 Skill 能力总览」言出法随卡顶栏展示定妆图**（资产：`src/prototypes/oneos-project-war-room/assets/yanchufasui-avatar.png`）。  
...
| 产物 | 先问本尊？ |
|------|------------|
| 需求 / 原型 | **否**（前提：靶子本尊已拍板、无歧义）→ 直接落；本尊在文件/预览验收 |
| 云效建单/推进 | **是** → 默认不上 |
